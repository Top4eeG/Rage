...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Пост успешно добавлен');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Пост успешно обновлён');
        }
        else{
            request()->session()->flash('error','Попробуйте снова!!');
        }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Пост успешно удалён');
        }
        else{
            request()->session()->flash('error','Ошибка во время удаления поста');
        }
        return redirect()->route('post.index');
    }
}
