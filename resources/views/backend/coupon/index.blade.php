...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Список купонов</h6>
      <a href="{{route('coupon.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Добавить купон"><i class="fas fa-plus"></i> Добавить купон</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($coupons as $coupon)
                <tr>
                    ...
                    <td>
                        @if($coupon->type=='fixed')
                            BYN {{number_format($coupon->value,2)}}
                        @else
                            {{$coupon->value}}%
                        @endif</td>
                    <td>
