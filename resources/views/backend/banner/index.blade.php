...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Добавить баннер"><i class="fas fa-plus"></i> Добавить баннер</a>
    </div>
    <div class="card-body">
