...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Список категорий</h6>
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Добавить категорию"><i class="fas fa-plus"></i> Добавить категорию</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    ...
                    {{--<td>{{$category->slug}}</td>--}}
                    <td>{{(($category->is_parent==1)? 'Да': 'Нет')}}</td>
                    <td>
        ...
        @else
          <h6 class="text-center">Категорий не найдено</h6>
        @endif
      </div>
    </div>
</div>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    title: "Вы уверены?",
                    text: "Удалив, вы не восстановите данные!",
                    icon: "warning",
                  buttons: {
