...
<div class="card">
    <h5 class="card-header">Редактировать категорию</h5>
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Введите название"  value="{{$category->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Описание</label>
        ...
        <div class="form-group">
          <label for="is_parent">Главная категория</label><br>
      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
          <label for="parent_id">Является подкатегорией</label>
