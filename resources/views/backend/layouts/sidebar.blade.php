<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Настройки баннеров:</h6>
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Настройки категорий:</h6>
    ...
    <li class="nav-item">
        ...
        <div id="productCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Настройки изделий:</h6>
            <a class="collapse-item" href="{{route('product.index')}}">Изделия</a>
            <a class="collapse-item" href="{{route('product.create')}}">Добавить изделия</a>
          </div>
        </div>
    </li>
    ...
    {{--<li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Настройки брендов:</h6>
    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Настройки доставки:</h6>
    ...
    <li class="nav-item">
      ...
      <div id="postCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Настройки постов:</h6>
    ...
    <li class="nav-item">
        ...
        <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Настройки фильтров:</h6>
            <a class="collapse-item" href="{{route('post-tag.index')}}">Фильтры</a>
            <a class="collapse-item" href="{{route('post-tag.create')}}">Добавить фильтр</a>
            </div>
        </div>
    </li>
