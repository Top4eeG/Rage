    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Введите название"  value="{{$post->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">Цитата</label>
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Вкратце <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="post_cat_id">Категория <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="added_by">Автор</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>Неактивен</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
