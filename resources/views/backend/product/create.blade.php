...
<div class="card">
    <h5 class="card-header">Добавить изделие</h5>
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_featured' id='is_featured' value='1' checked> Да
        </div>
              {{-- {{$categories}} --}}
        ...
        <div class="form-group">
          ...
          <input id="price" type="number" name="price" placeholder="Введите цену"  value="{{old('price')}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Введите процент скидки"  value="{{old('discount')}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="XL">Огромный (XL)</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="hot">Популярное</option>
          </select>
        </div>

        <div class="form-group">
          <label for="stock">Количество <span class="text-danger">*</span></label>
          <input id="quantity" type="number" name="stock" min="0" placeholder="Введите количество"  value="{{old('stock')}}" class="form-control">
          @error('stock')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
