							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="total-amount" data-title="Total"><span>BYN {{$wishlist['amount']}}</span></td>
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>Добавить в корзину</a></td>
							...
							@else
								<tr>
									<td class="text-center">
										Вы ничего не добавили в избранное. <a href="{{route('product-grids')}}" style="color:blue;">В магазин</a>
                                ...
                                <div class="quickview-content">
                                    ...
                                    <div class="quickview-ratting-review">
                                        <div class="quickview-ratting-wrap">
                                            ...
                                            <a href="#"> (1 отзыв пользователей)</a>
                                        </div>
                                        <div class="quickview-stock">
                                            <span><i class="fa fa-check-circle-o"></i> на складе</span>
                                        </div>
                                    </div>
                                    <h3>BYN 29.00</h3>
