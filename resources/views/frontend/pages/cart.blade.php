								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>BYN {{number_format($cart['price'],2)}}</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">BYN {{$cart['amount']}}</span></td>
								...
								@else
										<tr>
											<td class="text-center">
												Ваша корзина пуста. <a href="{{route('product-grids')}}" style="color:blue;">В магазин</a>
							...
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											@csrf
											<input name="code" placeholder="Введите купон">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Скидка<span>BYN {{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Вы заплатите<span>BYN {{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Вы заплатите<span>BYN {{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
									<div class="button5">
										<a href="{{route('checkout')}}" class="btn">Заказать</a>
										<a href="{{route('product-grids')}}" class="btn">В магазин</a>
									</div>
								</div>
							</div>
						</div>
