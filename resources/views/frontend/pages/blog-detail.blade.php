                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Блог</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>От {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Комментариев ({{$post->allComments->count()}})</a></span>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Оставить комментарий</span><span class="comment_btn reply" style="display: none;">Ответить</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Вам нужно <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Войти</a> или <a style="color:blue" href="{{route('register.form')}}">Зарегистрироваться</a> для комментирования.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget recent-post">
                            <h3 class="title">Недавние посты</h3>
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">Новостная подписка</h3>
                            <div class="letter-inner">
                                <h4>ПОДПИШИТЕСЬ И<br> ПОЛУЧАЙТЕ НОВОСТИ.</h4>
                                <form action="{{route('subscribe')}}" method="POST">
                                    @csrf
                                    <div class="form-inner">
                                        <input type="email" name="email" placeholder="Ваш email">
                                        <button type="submit" class="btn mt-2">Подписаться</button>
                                    </div>
                                </form>
                            </div>
                        </div>
